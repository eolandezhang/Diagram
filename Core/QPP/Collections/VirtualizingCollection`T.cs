...
{
    public class VirtualizingCollection<T> : IList<T>, IBindingList, IList, INotifyCollectionChanged, INotifyPropertyChanged
        where T : DataModel
    {
        ...
        protected IList<T> FetchPage(int pageIndex)
        {
            ...
            if (m_PropertyDescriptor != null)
                sort = m_PropertyDescriptor.Name + (m_ListSortDirection == ListSortDirection.Descending ? " DESC" : " ASC");
            return ItemsProvider.FetchRange(pageIndex * PageSize, PageSize, sort);
        }
