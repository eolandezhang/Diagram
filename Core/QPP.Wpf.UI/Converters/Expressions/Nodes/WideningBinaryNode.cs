namespace QPP.Wpf.UI.Converters.Expressions.Nodes
{
    ...
    internal abstract class WideningBinaryNode : BinaryNode
    {
        ...
        public sealed override object Evaluate(NodeEvaluationContext evaluationContext)
        {
            ...
            if (!succeeded)
                throw new ParseException("Operator '{0}' cannot be applied to operands of type '{1}' and '{2}'.".FormatArgs(this.OperatorSymbols, leftNodeValueType, rightNodeValueType));
