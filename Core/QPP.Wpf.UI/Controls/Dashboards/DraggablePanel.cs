...
//-----------------------------------------------------------------------
namespace QPP.Wpf.UI.Controls.Dashboards
{
    using System;
    using System.Net;
    ...
    using QPP.Wpf.UI.Controls.Animation;

    /// <summary>
    /// Base class for draggable panels.
    /// </summary>
    public class DraggablePanel : QPP.Wpf.UI.Controls.Animation.AnimatedHeaderedContentControl
    {
        /// <summary>
