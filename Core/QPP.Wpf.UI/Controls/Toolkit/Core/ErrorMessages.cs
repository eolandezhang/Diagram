...
namespace QPP.Wpf.UI.Controls.Toolkit.Core
{
  internal static class ErrorMessages
  {
    ...
    {
      _resourceManager = new ResourceManager( "QPP.Wpf.UI.Controls.Toolkit.Core.ErrorMessages", typeof( ErrorMessages ).Assembly );
    }
