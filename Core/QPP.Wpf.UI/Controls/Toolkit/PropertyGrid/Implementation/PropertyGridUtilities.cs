...
using QPP.Wpf.UI.Controls.Toolkit.PropertyGrid.Attributes;
using QPP.Wpf.UI.Controls.Toolkit.PropertyGrid.Editors;
...
using QPP.Wpf.UI.Controls.Toolkit.PropertyGrid.Converters;
using QPP.Wpf.UI.Controls.Toolkit.Primitives;

namespace QPP.Wpf.UI.Controls.Toolkit.PropertyGrid
{
      ...
      else
      {
        ...
        if( listType != null )
        {
          if( !listType.IsPrimitive && !listType.Equals( typeof( String ) ) )
            editor = new QPP.Wpf.UI.Controls.Toolkit.PropertyGrid.Editors.CollectionEditor();
          else
            editor = new QPP.Wpf.UI.Controls.Toolkit.PropertyGrid.Editors.PrimitiveTypeCollectionEditor();
        }
        else
        {
