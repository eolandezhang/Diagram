...
using QPP.Wpf.UI.Controls.Toolkit.Primitives;
using QPP.Wpf.UI.Controls.Toolkit.Core.Utilities;
...
namespace QPP.Wpf.UI.Controls.Toolkit
{
  ...
  public class CheckComboBox : QPP.Wpf.UI.Controls.Toolkit.Primitives.Selector
  {
    ...
    public CheckComboBox()
    {
      ...
      this.MouseLeftButtonUp += new MouseButtonEventHandler(CheckComboBox_MouseLeftButtonUp);
      this.MouseLeave +=new MouseEventHandler(CheckComboBox_MouseLeave);
    ...
    #region MouseLeftButtonUpEventHander and MouseLeaveEventHander

    int mouseLeftButtonUpTimes = 0;
    void CheckComboBox_MouseLeftButtonUp(object sender, MouseButtonEventArgs e)
    {
        ++mouseLeftButtonUpTimes;
        if (mouseLeftButtonUpTimes % 2 == 1)
        {
            var btn = GetTemplateChild(PART_DropDownButton) as ToggleButton;
            btn.IsChecked = !btn.IsChecked;
        }
    }
    void CheckComboBox_MouseLeave(object sender, MouseEventArgs e)
    {
        mouseLeftButtonUpTimes = 0;
    }
