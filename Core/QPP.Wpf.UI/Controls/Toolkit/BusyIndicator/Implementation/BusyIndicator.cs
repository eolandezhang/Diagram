...
namespace QPP.Wpf.UI.Controls.Toolkit
{
    ...
    public class BusyIndicator : ContentControl
    {
        ...
        /// </summary>
        private DispatcherTimer _displayAfterTimer = new DispatcherTimer(DispatcherPriority.Send);
        ...
        void Content_DataContextChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            Util.ApplyResourceDictionary(rd, Resources);
        }
        ...
        {
            VisualStateManager.GoToState(this, !Util.IsDesignMode && IsBusy ? VisualStates.StateBusy : VisualStates.StateIdle, useTransitions);
            VisualStateManager.GoToState(this, !Util.IsDesignMode && IsContentVisible ? VisualStates.StateVisible : VisualStates.StateHidden, useTransitions);
        }
