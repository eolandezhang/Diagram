...
namespace QPP.Wpf.UI.Controls.AvalonEdit.Highlighting.Xshd
{
	/// <summary>
	...
	{
		public const string Namespace = "http://QPP.Wpf.UI.Controls.net/sharpdevelop/syntaxdefinition/2008";
