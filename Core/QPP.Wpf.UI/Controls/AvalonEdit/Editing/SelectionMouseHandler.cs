...
using QPP.Wpf.UI.Controls.AvalonEdit.Rendering;
using QPP.Wpf.UI.Controls.AvalonEdit.Utils;

namespace QPP.Wpf.UI.Controls.AvalonEdit.Editing
{
	/// <summary>
		...
		void StartDrag()
		{
			...
			using (textArea.AllowCaretOutsideSelection()) {
				...
				try {
                    ...
                    resultEffect = System.Windows.DragDrop.DoDragDrop(textArea, dataObject, allowedEffects);
