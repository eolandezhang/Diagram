...
namespace QPP.Wpf.UI.Controls.Gantt.TimespanHeader
{
    ...
    public class TimespanHeaderRow : Control
    {
        public static DependencyProperty CellHorizontalAlignmentProperty = 
            DependencyProperty.Register("CellHorizontalAlignment", typeof(HorizontalAlignment), typeof(TimespanHeaderRow), 
            new PropertyMetadata(HorizontalAlignment.Center));
        public static DependencyProperty CellVerticalAlignmentProperty = 
            DependencyProperty.Register("CellVerticalAlignment", typeof(VerticalAlignment), typeof(TimespanHeaderRow), 
            new PropertyMetadata(VerticalAlignment.Center));
        public static DependencyProperty CellBorderThicknessProperty = 
            DependencyProperty.Register("CellBorderThickness", typeof(Thickness), typeof(TimespanHeaderRow), 
            new PropertyMetadata(new Thickness(1)));
        public static DependencyProperty CellBorderBrushProperty = 
            DependencyProperty.Register("CellBorderBrush", typeof(Brush), typeof(TimespanHeaderRow), 
            new PropertyMetadata(new SolidColorBrush(Colors.Black)));
        public static DependencyProperty CellBackgroundProperty =
            DependencyProperty.Register("CellBackground", typeof(Brush), typeof(TimespanHeaderRow), 
            new PropertyMetadata(new SolidColorBrush(Colors.Transparent)));
        public static DependencyProperty TimeUnitProperty =
            DependencyProperty.Register("TimeUnit", typeof(TimeUnits), typeof(TimespanHeaderRow), 
            new PropertyMetadata(TimeUnits.Months));
        public static DependencyProperty CurrentTimeProperty =
            DependencyProperty.Register("CurrentTime", typeof(DateTime), typeof(TimespanHeaderRow), 
            new PropertyMetadata(DateTime.Now));
        public static DependencyProperty CellFormatProperty =
            DependencyProperty.Register("CellFormat", typeof(string), typeof(TimespanHeaderRow), 
