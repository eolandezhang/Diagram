...
namespace QPP.Wpf.UI.Actions
{
    public class EventToCommand : TriggerAction<DependencyObject>
    {
        ...
        {
            var thisType = typeof(EventToCommand);
            CommandParameterProperty = DependencyProperty.Register("CommandParameter", typeof(object), thisType, new PropertyMetadata(null, (s, e) =>
            {
            ...
            CommandProperty = DependencyProperty.Register("Command", typeof(ICommand), thisType, new PropertyMetadata(null, (s, e) => OnCommandChanged(s as EventToCommand, e)));
            MustToggleIsEnabledProperty = DependencyProperty.Register("MustToggleIsEnabled", typeof(bool), thisType, new PropertyMetadata(false, (s, e) =>
            {
                var sender = s as EventToCommand;
                if (sender == null)
                    return;
